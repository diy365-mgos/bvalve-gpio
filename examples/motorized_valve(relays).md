# Control a motorized valve using MQTT (relays version)
## Overview
...
<img src="docs/example-motorized(relays)-v2.png" width="60%"></img>
## Firmware
...
enum mgos_app_init_result mgos_app_init(void) {
  ...
  mgos_bvalve_gpio_attach(v01, 4, true, 5, true, 7, MGOS_BVALVE_GPIO_POWER_PIN2);
